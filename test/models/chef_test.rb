...
class ChefTest < ActiveSupport::TestCase
  ...
  test "email should accept correct format" do
    valid_emails = %w[user@example.com Dan@gmail.com d.bonehill@yahoo.com]
  ...
  test "email should reject invalid addresses" do
    invalid_emails = %w[user@example dan@gmail,com d.bonehill@yahoo.]
